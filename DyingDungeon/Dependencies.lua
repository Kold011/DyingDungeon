...
Dependencies = {
	DirectXTK = {
		LibName = "DirectXTK",
		LibDir = "%{wks.location}/Vendor/DirectXTK/Lib/%{cfg.architecture}/%{cfg.buildcfg}/",
		IncludeDir = "%{wks.location}/Vendor/DirectXTK/include/",
	},
	Winmm = {
		LibName = "winmm",
		LibDir = "%{wks.location}/Vendor/winmm/Lib/",
	},
}
